...
## Coreografia linear (32 slides, uma pessoa)
...
| 10:57-11:20 | 20-26 | Deck | um passo por slide: Ler, Tokens, Auditar (o uau), Gerar, Inspecionar, Corrigir, Revogar; sala copia prompts do guia |
| ~11:12 | durante 24 | demo (opcional, 2 min) | mostra a SUA verificação das 3 propriedades e volta |
| 11:20-11:24 | 27 | Deck (demo opcional se sala tímida) | leitura das divergências; preview de palco só se sobrar tempo |
| 11:24-11:42 | 28-32 | Deck até o fim | limites, boas práticas, perguntas, síntese, formulário + surpresa |

Total de idas ao Space da demo: 3 obrigatórias (slides 9, 10, 11) + 2 opcionais (24, 27).

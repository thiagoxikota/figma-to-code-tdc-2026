...
- [ ] Deck canônico (Google Slides, link em `slides/README.md`) abre e apresenta na máquina de palco; `slides/deck.pdf` (export de 22/07, 30 páginas, 16:9) abre em tela cheia como fallback offline, sem mojibake (acentos corretos: código, peças, Florianópolis), sem corte de conteúdo no projetor.
